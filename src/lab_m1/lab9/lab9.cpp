...
void Lab9::Init()
{
    ...
    {
        mapTextures["rand"] = CreateRandomTexture(25, 25);
    }
...
void Lab9::Update(float deltaTimeSeconds)
{
...

    {
        ...
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, mapTextures["rand"]);
    }
...

    {
        mixer = 1;
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(0.f, 1.5f, 1.0f));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.5f));
        RenderSimpleMesh(meshes["square"], shaders["LabShader"], modelMatrix, mapTextures["rand"], mapTextures["crate"]);
        mixer = 0;
    }
